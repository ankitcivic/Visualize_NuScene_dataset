...
class NuScenesExplorer:
    ...
    def map_pointcloud_to_image(self,
        ...
        a = pc.rotate(Quaternion(cs_record['rotation']).rotation_matrix)
        ...
        print('___________ \n')
        print('Step 1 \n')
        print('Points live in the point sensor frame. So they need to be transformed via global to the image plane. \n First step: transform the pointcloud to the ego vehicle frame for the timestamp of the sweep. \n')
        print(cs_record)
        ...
        print('___________ \n')
        print('Step 2 \n')
        print('transform from ego to the global frame \n')
        print(poserecord)
        ...
        print('___________ \n')
        print('Step 3 \n')
        print('transform from global into the ego vehicle frame for the timestamp of the image. \n')
        print(poserecord)
        ...
        print('___________ \n')
        print('Step 4 \n')
        print('transform from ego into the camera.\n')
        print(cs_record)
